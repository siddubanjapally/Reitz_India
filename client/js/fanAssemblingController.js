...
(function() {
  (angular.module('reitz')).controller('fanAssemblingController', function($scope, $route, $location, $routeParams, $rootScope, projectservice, ReitzResources, chartService) {
