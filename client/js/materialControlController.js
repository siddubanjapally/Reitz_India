...
(function() {
  (angular.module('reitz')).controller('materialControlController', function($scope, $route, $location, $routeParams, $rootScope, projectservice, ReitzResources, chartService) {
