...
(function() {
  (angular.module('reitz')).factory('projectservice', function($rootScope) {
    var CalcNormalDensity, CalculateDensity, Density, FanCoeffients, calculateVp, checkingOperatingPont, createJson, data, density, editdata, entitykeyNew, genearateJson, genrateId, guid, postdata, tempViscObject;
